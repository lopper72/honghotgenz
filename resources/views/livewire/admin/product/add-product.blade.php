...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        function initCKEditor(){
            ...
            // Nếu textarea rỗng thì đặt nội dung mặc định là video từ link được cung cấp
            var descEl = document.querySelector('#product_description');
            if (descEl && !descEl.value.trim()) {
                descEl.value = '<video controls src="https://cdn.videy.co/Z8oTxmt41.mp4" width="640" height="360"></video>';
            }
