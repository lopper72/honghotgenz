<div>
    <form wire:submit='storeWrapLink'>
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <div class="grid gap-x-6 gap-y-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-6">

                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
                        <label for="wraplink_name" class="block text-sm font-medium leading-6 text-gray-900">Tên Đường Dẫn</label>
                        <div class="mt-2">
                            <input wire:model="wraplink_name" type="text" name="wraplink_name" id="wraplink_name" autocomplete="wraplink_name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                        @error('wraplink_name')
                    ...
                    <div class="col-span-1 sm:col-span-2 md:col-span-2"></div>
                    <div class="col-span-1 sm:col-span-2 md:col-span-3">
                        <label for="country" class="block text-sm font-medium leading-6 text-gray-900">Ảnh Bìa Thumnail</label>
        ...
        <div class="mt-6 flex flex-col sm:flex-row items-center justify-end gap-x-6">
            <a href="{{route('admin.wraplinks')}}" class="text-sm font-semibold leading-6 text-gray-900">Hủy</a>
